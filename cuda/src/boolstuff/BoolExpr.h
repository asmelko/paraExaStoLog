/*  $Id: BoolExpr.h,v 1.24 2015/01/21 01:47:40 sarrazip Exp $
...
public:
    ...
    */
    ...
    /**
        ...
        CAUTION: do not destroy 'root' after calling this method;
        the tree rooted at 'root' has typically been transformed
        by this method; destroy the tree rooted at the returned
        pointer instead.
    ...
    */
    ...
    /**
        ...
        @returns          the root of the transformed tree (may be NULL);
                          see the caution messages for getDisjunctiveNormalForm()
    */
