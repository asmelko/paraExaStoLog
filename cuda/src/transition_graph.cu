									...
									index_t level)
{
	...
	for (int i = 0; i < sccs_n; i++)
	{
...

		{
			...
			print("scc_reordered_vertices first half after level " + std::to_string(level) + " ", scc_reordered_vertices, 20);
